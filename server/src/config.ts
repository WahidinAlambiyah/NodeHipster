...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'NodeHipster';
  ...
  'jhipster.mail.from' = 'NodeHipster@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'NodeHipster API';
  'jhipster.swagger.description' = 'NodeHipster API documentation';
  ...
  'eureka.instance.appname' = 'NodeHipster';
  'eureka.instance.instanceId' = 'NodeHipster:${random.value}';
